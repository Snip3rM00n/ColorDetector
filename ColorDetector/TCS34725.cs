/*
	...
	Purpose:
		Does the heavy lifting:
			...
			-Reads/Writes Data from ColorSensor
			-Initiates call to The Color API using ApiHelper using data from sensor
			-Returns ColorfulRestProperty from The Color API data.

	Hardware:
		-An AdaFruit TCS34725 RGB Sensor	(http://www.adafruit.com/products/1334)
		-Raspberry Pi 2 Model B				(http://www.adafruit.com/product/2358)
		-Tactile Button Switch				(http://www.adafruit.com/products/367)
		-10k Ohm Resistor
		-8 Wires
			-5 Female to Male
			-3 Male to Male
	
	See Fritzing for layout.
*/
